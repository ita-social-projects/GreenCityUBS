...
@RestController
@RequestMapping("/ubs/order-client")
public class OrderClientController {
    ...
    public ResponseEntity<OrderClientDto> cancelFormedOrder(
        ...
        ubsClientService.cancelFormedOrder(orderId);
    ...
    public ResponseEntity<OrderClientDto> makeOrderAgain(@PathVariable(name = "id") Long orderId) {
