...
public class LocationApiServiceTest {
    ...
    public void testGetRegionByName() {
        String apiUrl = "https://directory.org.ua/api/katottg?page_size=5000&name=Вінницька&level=1";
    ...
    public void testGetCityByNameAndRegionName() {
        ...
        when(restTemplate.getForEntity("https://directory.org.ua/api/katottg?page_size=5000&name=Вінницька&level=1",
            Map.class)).thenReturn(prepareResponseEntity(Arrays.asList(apiResult1, apiResult2, apiResult3)));
        when(restTemplate.getForEntity(
            "https://directory.org.ua/api/katottg?page_size=2&code=UA05020000000026686&level=2", Map.class))
                .thenReturn(prepareResponseEntity(Arrays.asList(apiResult21)));
        when(restTemplate.getForEntity(
            "https://directory.org.ua/api/katottg?page_size=2&code=UA05020030000031457&level=3", Map.class))
...
//        assertTrue(exception.getMessage().contains(ErrorMessage.CITY_NOT_FOUND));
    ...
    public void testGetLocalCommunity() {
        String apiUrl = "https://directory.org.ua/api/katottg?page_size=5000&parent=UA05020000000026686&level=3";
        Map<String, Object> apiResult1 =
