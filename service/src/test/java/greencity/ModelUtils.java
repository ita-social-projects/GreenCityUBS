...
public class ModelUtils {
    ...
    public static TelegramChat getTelegramBotNotifyTrue() {
        return new TelegramChat(1L, "12345", false, true, "username", "first_name", "last_name", null, new ArrayList<>());
    }

    public static TelegramChat getTelegramBotNotifyFalse() {
        return new TelegramChat(1L, "12345", false, false, "username", "first_name", "last_name", null, new ArrayList<>());
    }
    ...
    private static OrderAddressDtoRequest createOrderDtoRequest() {
        return OrderAddressDtoRequest.builder()
            .id(13L).cityUk("Kyiv").districtUk("Svyatoshyn")
    ...
    public static EventDto getDtoWithLanguage(String language, Event event) {
        return switch (language) {
            ...
            case "en" -> EventDto.builder()
                .eventDate(event.getEventDate())
                .eventName(event.getEventNameEn())
                .authorName(event.getAuthorNameEn())
                .build();
