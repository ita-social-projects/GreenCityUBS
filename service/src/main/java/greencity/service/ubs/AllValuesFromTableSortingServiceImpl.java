...
@Service
@AllArgsConstructor
public class AllValuesFromTableSortingServiceImpl implements AllValuesFromTableSortingService {
    ...
    public List<GetAllFieldsMainDto> getAllSortingValues(String column, String sortingType) {
        ...
        for (Map<String, Object> map : maps) {
            employees = jdbcTemplate.queryForList(emplQuery + map.get("orderid"));
