...
public class UBSManagementServiceImpl implements UBSManagementService {
    ...
    public TableParamsDTO getParametersForOrdersTable(Long userId) {
        List<ColumnStateDTO> columnStateDTOS = Collections.unmodifiableList(new ArrayList<>(Arrays.asList(
            new ColumnStateDTO("select", new TitleDto("Вибір", "Select"), 20, true, false, 0, EditType.CHECKBOX),
            new ColumnStateDTO("orderid", new TitleDto("Замовлення ID", "Order ID"), 20, true, false, 1,
                EditType.READ_ONLY),
            new ColumnStateDTO("order_status", new TitleDto("Cтатус замовлення", "Order sataus"), 20, true, false, 2,
                EditType.SELECT),
            new ColumnStateDTO("order_date", new TitleDto("Аааа", "Aaaa"), 20, true, true, 3, EditType.DATE),
            new ColumnStateDTO("clientname", new TitleDto("Ббббб", "Bbbb"), 20, false, true, 4, EditType.INLINE),
            new ColumnStateDTO("phone_number", new TitleDto("Вввв", "Cccc"), 20, false, true, 5, EditType.INLINE),
            new ColumnStateDTO("email", new TitleDto("Гггг", "Dddd"), 20, true, false, 6, EditType.INLINE),
            new ColumnStateDTO("violations", new TitleDto("Дддд", "Eeee"), 20, true, false, 7, EditType.READ_ONLY),
            new ColumnStateDTO("district", new TitleDto("Еееее", "Ffff"), 20, true, false, 8, EditType.READ_ONLY),
            new ColumnStateDTO("address", new TitleDto("Єєєє", "Gggg"), 20, true, false, 9, EditType.READ_ONLY),
            ...
            new ColumnStateDTO("comment_to_address_for_client", new TitleDto("Іііі", ""), 20, true, false, 13,
                EditType.INLINE),
            new ColumnStateDTO("garbage_bags_120_amount", new TitleDto("Їїїїї", "Kkkk"), 20, true, false, 14,
                EditType.INLINE),
            new ColumnStateDTO("bo_bags_120_amount", new TitleDto("Йййй", "Lllll"), 20, true, false, 15,
                EditType.INLINE),
            new ColumnStateDTO("bo_bags_20_amount", new TitleDto("Кккк", "Mmmmm"), 20, true, false, 16,
                EditType.INLINE),
            new ColumnStateDTO("total_order_sum", new TitleDto("Ллллл", "Nnnn"), 20, true, false, 17,
                EditType.READ_ONLY),
            new ColumnStateDTO("order_certificate_code", new TitleDto("Мммм", "Ssss"), 20, true, false, 18,
                EditType.READ_ONLY),
            new ColumnStateDTO("order_certificate_points", new TitleDto("Ннннн", "Ttttt"), 20, true, false, 19,
                EditType.READ_ONLY),
            new ColumnStateDTO("amount_due", new TitleDto("Ооооо", ""), 20, true, false, 20, EditType.READ_ONLY),
            new ColumnStateDTO("comment_for_order_by_client", new TitleDto("Пппп", "Rrrr"), 20, true, false, 21,
                EditType.INLINE),
            ...
            new ColumnStateDTO("time_of_export", new TitleDto("Ттттт", "Zzzzz"), 20, true, false, 24,
                EditType.READ_ONLY),
            new ColumnStateDTO("id_order_from_shop", new TitleDto("Уууу", "Hhhkh"), 20, true, false, 25,
                EditType.READ_ONLY),
            new ColumnStateDTO("receiving_station", new TitleDto("Ффффф", ""), 20, true, false, 26, EditType.READ_ONLY),
            new ColumnStateDTO("responsible_manager", new TitleDto("Хххх", "Rytryt"), 20, true, false, 27,
                EditType.SELECT),
            new ColumnStateDTO("responsible_logic_man", new TitleDto("Цццц", "Hhjkhk"), 20, true, false, 28,
                EditType.SELECT),
            new ColumnStateDTO("responsible_driver", new TitleDto("Чччч", "Wwrwew"), 20, true, false, 29,
                EditType.SELECT),
            new ColumnStateDTO("responsible_navigator", new TitleDto("Шшшш", "Qqeqw"), 20, true, false, 30,
                EditType.SELECT),
            new ColumnStateDTO("comments_for_order", new TitleDto("Щщщщ", "Mjhjhk"), 20, true, false, 31,
                EditType.INLINE))));
