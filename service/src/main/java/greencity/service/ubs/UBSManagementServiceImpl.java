...
public class UBSManagementServiceImpl implements UBSManagementService {
    ...
    public TableParamsDTO getParametersForOrdersTable(Long userId) {
        List<ColumnStateDTO> columnStateDTOS = Collections.unmodifiableList(new ArrayList<>(Arrays.asList(
            new ColumnStateDTO("select", new TitleDto("SELECT", "Вибір", "Select"), 20, true, true, 0, EditType.CHECKBOX,
                new ArrayList<>()),
            new ColumnStateDTO("orderid", new TitleDto("ORDER_ID", "Номер замовлення", "Order ID"), 20, true, false, 1,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("order_status", new TitleDto("ORDER_STATUS", "Cтатус замовлення", "Order sataus"), 20, true, true, 2,
                EditType.SELECT, orderStatusListForDevelopStage()),
            new ColumnStateDTO("payment_status", new TitleDto("PAYMENT_STATUS", "Статус оплати", "Aaaa"), 20, true, true, 3,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("order_date", new TitleDto("ORDER_DATE", "Дата замовлення", "Aaaa"), 20, true, true, 4,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("payment_date", new TitleDto("PAYMENT_DATE", "Дата оплати", "Aaaa"), 20, true, true, 5,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("client_name", new TitleDto("CLIENT_NAME", "Ім'я замовника", "Bbbb"), 20, false, true, 6,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("phone_number", new TitleDto("PHONE_NUMBER", "Телефон замовника", "Cccc"), 20, false, true, 7,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("email", new TitleDto("EMAIL", "Email замовника", "Dddd"), 20, false, true, 8,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("sender_name", new TitleDto("SENDER_NAME", "Ім'я відправника", "Hhhhh"), 20, false, true, 9,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("sender_phone", new TitleDto("SENDER_PHONE", "Телефон відправника", "Oooo"), 20, false, true, 10,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("sender_email", new TitleDto("SENDER_EMAIL", "Email відправника", "Pppp"), 20, false, true, 11,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("violations", new TitleDto("VIOLATIONS", "Кількість порушень клієнта", "Eeee"), 20, false, true, 12,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("location", new TitleDto("LOCATION", "Локація", "Eeee"), 20, false, true, 13, EditType.READ_ONLY,
                new ArrayList<>()),
            new ColumnStateDTO("district", new TitleDto("DISTRICT", "Район", "Ffff"), 20, false, true, 14, EditType.READ_ONLY,
                new ArrayList<>()),
            new ColumnStateDTO("address", new TitleDto("ADDRESS", "Адреса", "Gggg"), 20, false, true, 15, EditType.READ_ONLY,
                new ArrayList<>()),
            new ColumnStateDTO("comment_to_address_for_client", new TitleDto("COMMENT_TO_ADDRESS_FOR_CLIENT", "Коментар до адреси від клієнта", ""), 20,
                false, true, 16, EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("bags_amount", new TitleDto("BAGS_AMOUNT", "К-сть пакетів", "Kkkk"), 20, false, true, 17,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("total_order_sum", new TitleDto("TOTAL_ORDER_SUM", "Сума замовлення", "Nnnn"), 20, false, true, 18,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("order_certificate_code", new TitleDto("ORDER_CERTIFICATE_CODE", "Номер сертифікату", "Ssss"), 20, false, true, 19,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("order_certificate_points", new TitleDto("ORDER_CERTIFICATE_POINTS", "Загальна знижка", "Ttttt"), 20, false, true,
                20, EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("amount_due", new TitleDto("AMOUNT_DUE", "Сума до оплати", "ttty"), 20, false, true, 21,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("comment_for_order_by_client",
                new TitleDto("COMMENT_FOR_ORDER_BY_CLIENT", "Коментар до замовлення від клієнта", "Rrrr"), 20, true, true, 22,
                EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("payment", new TitleDto("PAYMENT", "Оплата", "Xxx"), 20, false, true, 23, EditType.READ_ONLY,
                new ArrayList<>()),
            new ColumnStateDTO("date_of_export", new TitleDto("DATE_OF_EXPORT", "Дата вивезення", "Yyyy"), 20, false, true, 24,
                EditType.DATE, new ArrayList<>()),
            new ColumnStateDTO("time_of_export", new TitleDto("TIME_OF_EXPORT", "Час вивезення", "Zzzzz"), 20, false, true, 25,
                EditType.TIME, new ArrayList<>()),
            new ColumnStateDTO("id_order_from_shop", new TitleDto("ID_ORDER_FROM_SHOP", "Номер замовлення з магазину", "Hhhkh"), 20, false,
                true, 26, EditType.READ_ONLY, new ArrayList<>()),
            new ColumnStateDTO("receiving_station", new TitleDto("RECEIVING_STATION", "Станція приймання", "jhkhjjk"), 20, false, true, 27,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("responsible_manager", new TitleDto("RESPONSIBLE_MANAGER", "Менеджер послуги", "Rytryt"), 20, false, true, 28,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("responsible_caller", new TitleDto("RESPONSIBLE_CALLER", "Менеджер обдзвону", "Rytryt"), 20, false, true, 29,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("responsible_logic_man", new TitleDto("RESPONSIBLE_LOGIC_MAN", "Логіст", "Hhjkhk"), 20, false, true, 30,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("responsible_driver", new TitleDto("RESPONSIBLE_DRIVER", "Водій", "Wwrwew"), 20, false, true, 31,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("responsible_navigator", new TitleDto("RESPONSIBLE_NAVIGATOR", "Штурман", "Qqeqw"), 20, false, true, 32,
                EditType.SELECT, orderOptionalListForDevelopStage()),
            new ColumnStateDTO("comments_for_order", new TitleDto("COMMENTS_FOR_ORDER", "Коментарі до замовлення", "Mjhjhk"), 20, false, true,
