...
public class UBSManagementServiceImpl implements UBSManagementService {
    ...
    public TableParamsDTO getParametersForOrdersTable(Long userId) {
        List<ColumnStateDTO> columnStateDTOS = new ArrayList<ColumnStateDTO>() {
            {
                add(new ColumnStateDTO("select", new TitleDto("", ""), 20, true, false, 0, EditType.CHECKBOX));
                add(new ColumnStateDTO("orderid", new TitleDto("Замовлення ID", "Order ID"), 20, true, false, 1,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("order_status", new TitleDto("Cтатус замовлення", "Order sataus"), 20, true,
                    false, 2, EditType.SELECT));
                add(new ColumnStateDTO("order_date", new TitleDto("Аааа", "Aaaa"), 20, true, true, 3, EditType.DATE));
                add(new ColumnStateDTO("clientname", new TitleDto("Ббббб", "Bbbb"), 20, false, true, 4,
                    EditType.INLINE));
                add(new ColumnStateDTO("phone_number", new TitleDto("Вввв", "Cccc"), 20, false, true, 5,
                    EditType.INLINE));
                add(new ColumnStateDTO("email", new TitleDto("Гггг", "Dddd"), 20, true, false, 6, EditType.INLINE));
                add(new ColumnStateDTO("violations", new TitleDto("Дддд", "Eeee"), 20, true, false, 7,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("district", new TitleDto("Еееее", "Ffff"), 20, true, false, 8,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("address", new TitleDto("Єєєє", "Gggg"), 20, true, false, 9,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("recipient_name", new TitleDto("Жжжж", "Hhhhh"), 20, true, false, 10,
                    EditType.INLINE));
                add(new ColumnStateDTO("recipient_phone", new TitleDto("Ззззз", "Oooo"), 20, true, false, 11,
                    EditType.INLINE));
                add(new ColumnStateDTO("recipient_email", new TitleDto("Иииии", "Pppp"), 20, true, false, 12,
                    EditType.INLINE));
                add(new ColumnStateDTO("comment_to_address_for_client", new TitleDto("Іііі", ""), 20, true, false, 13,
                    EditType.INLINE));
                add(new ColumnStateDTO("garbage_bags_120_amount", new TitleDto("Їїїїї", "Kkkk"), 20, true, false, 14,
                    EditType.INLINE));
                add(new ColumnStateDTO("bo_bags_120_amount", new TitleDto("Йййй", "Lllll"), 20, true, false, 15,
                    EditType.INLINE));
                add(new ColumnStateDTO("bo_bags_20_amount", new TitleDto("Кккк", "Mmmmm"), 20, true, false, 16,
                    EditType.INLINE));
                add(new ColumnStateDTO("total_order_sum", new TitleDto("Ллллл", "Nnnn"), 20, true, false, 17,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("order_certificate_code", new TitleDto("Мммм", "Ssss"), 20, true, false, 18,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("order_certificate_points", new TitleDto("Ннннн", "Ttttt"), 20, true, false, 19,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("amount_due", new TitleDto("Ооооо", ""), 20, true, false, 20,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("comment_for_order_by_client", new TitleDto("Пппп", "Rrrr"), 20, true, false, 21,
                    EditType.INLINE));
                add(new ColumnStateDTO("payment_system", new TitleDto("Рррр", "Xxx"), 20, true, false, 22,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("date_of_export", new TitleDto("Сссс", "Yyyy"), 20, true, false, 23,
                    EditType.DATE));
                add(new ColumnStateDTO("time_of_export", new TitleDto("Ттттт", "Zzzzz"), 20, true, false, 24,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("id_order_from_shop", new TitleDto("Уууу", "Hhhkh"), 20, true, false, 25,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("receiving_station", new TitleDto("Ффффф", ""), 20, true, false, 26,
                    EditType.READ_ONLY));
                add(new ColumnStateDTO("responsible_manager", new TitleDto("Хххх", "Rytryt"), 20, true, false, 27,
                    EditType.SELECT));
                add(new ColumnStateDTO("responsible_logic_man", new TitleDto("Цццц", "Hhjkhk"), 20, true, false, 28,
                    EditType.SELECT));
                add(new ColumnStateDTO("responsible_driver", new TitleDto("Чччч", "Wwrwew"), 20, true, false, 29,
                    EditType.SELECT));
                add(new ColumnStateDTO("responsible_navigator", new TitleDto("Шшшш", "Qqeqw"), 20, true, false, 30,
                    EditType.SELECT));
