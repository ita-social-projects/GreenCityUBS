...
public class OrdersAdminsPageServiceImpl implements OrdersAdminsPageService {
    ...
    public TableParamsDTO getParametersForOrdersTable(Long userId) {
        List<ColumnStateDTO> columnStateDTOS = Collections.unmodifiableList(new ArrayList<>(Arrays.asList(
            ...
            new ColumnStateDTO(new TitleDto("paymentDate", "Дата оплати", "Payment date"), "need to implement", 20, false, true, 5, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("clientName", "Ім'я замовника", "Client name"), "need to implement", 20, false, true, 6, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("phoneNumber", "Телефон замовника", "Phone number"), "user.recipientPhone", 20, false, true, 7, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("email", "Email замовника", "Email"), "user.recipientEmail", 20, false, true, 8, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderName", "Ім'я відправника", "Sender name"), "need to implement", 20, false, true, 9, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderPhone", "Телефон відправника", "Sender phone"), "ubsUser.phoneNumber", 20, false, true, 10, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderEmail", "Email відправника", "Sender email"), "ubsUser.email", 20, false, true, 11, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("violationsAmount", "Кількість порушень клієнта", "Violations"), "user.violations", 20, false, true, 12, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("location", "Локація", "Location"), "user.lastLocation", 20, false, true, 13, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            ...
            new ColumnStateDTO(new TitleDto("address", "Адреса", "Address"), "need to implement", 20, false, true, 15, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("commentToAddressForClient", "Коментар до адреси від клієнта", "Comment to address for client"), "", 20, false, true, 16, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("bagsAmount", "К-сть пакетів", "Bags amount"), "", 20, false, true, 17, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("totalOrderSum", "Сума замовлення", "Total order sum"), "need to implement", 20, false, true, 18, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("orderCertificateCode", "Номер сертифікату", "Order certificate code"), "", 20, false, true, 19, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("orderCertificatePoints", "Загальна знижка", "Order certificate points"), "pointsToUse", 20, false, true, 20, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("amountDue", "Сума до оплати", "Amount due"), "need to implement", 20, false, true, 21, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("commentForOrderByClient", "Коментар до замовлення від клієнта", "Comment for order by client"), "", 20, true, true, 22, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("payment", "Оплата", "Payment"), "need to implement", 20, false, true, 23, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            ...
            new ColumnStateDTO(new TitleDto("timeOfExport", "Час вивезення", "Time of export"), "need to implement", 20, false, true, 25, EditType.TIME, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("idOrderFromShop", "Номер замовлення з магазину", "Id order from shop"), "", 20, false, true, 26, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            ...
            new ColumnStateDTO(new TitleDto("responsibleManager", "Менеджер послуги", "Responsible manager"), "", 20, false, true, 28, EditType.SELECT, managerList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleCaller", "Менеджер обдзвону", "Responsible caller"), "", 20, false, true, 29, EditType.SELECT, callerList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleLogicMan", "Логіст", "Responsible logic man"), "", 20, false, true, 30, EditType.SELECT, logicManList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleDriver", "Водій", "Responsible driver"), "", 20, false, true, 31, EditType.SELECT, driverList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleNavigator", "Штурман", "Responsible navigator"), "", 20, false, true, 32, EditType.SELECT, navigatorList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("commentsForOrder", "Коментарі до замовлення", "Comments for order"), "", 20, false, true, 33, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"))));
