...
public class OrdersAdminsPageServiceImpl implements OrdersAdminsPageService {
    ...
    public TableParamsDTO getParametersForOrdersTable(Long userId) {
        List<ColumnStateDTO> columnStateDTOS = Collections.unmodifiableList(new ArrayList<>(Arrays.asList(
            new ColumnStateDTO(new TitleDto("select", "Вибір", "Select"), "", 20, true, true, 0, EditType.CHECKBOX, new ArrayList<>(), ""),
            new ColumnStateDTO(new TitleDto("id", "Номер замовлення", "Order's number"), "id", 20, true,false, 1, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("orderStatus", "Статус замовлення", "Order's status"), "orderStatus", 20, true, true, 2, EditType.SELECT, orderStatusListForDevelopStage(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("paymentStatus", "Статус оплати", "Payment status"), "paymentStatus", 20, false, true, 3, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("orderDate", "Дата замовлення", "Order date"), "orderDate", 20, false, true, 4, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("paymentDate", "Дата оплати", "Payment date"), "paymentDate", 20, false, true, 5, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_INFO"),
            new ColumnStateDTO(new TitleDto("clientName", "Ім'я замовника", "Client name"), "user.clientName", 20, false, true, 6, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("phoneNumber", "Телефон замовника", "Phone number"), "user.phoneNumber", 20, false, true, 7, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("email", "Email замовника", "Email"), "user.email", 20, false, true, 8, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderName", "Ім'я відправника", "Sender name"), "ubsUser.senderName", 20, false, true, 9, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderPhone", "Телефон відправника", "Sender phone"), "ubsUser.senderPhone", 20, false, true, 10, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("senderEmail", "Email відправника", "Sender email"), "ubsUser.senderEmail", 20, false, true, 11, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("violationsAmount", "Кількість порушень клієнта", "Violations"), "ubsUser.violationsAmount", 20, false, true, 12, EditType.READ_ONLY, new ArrayList<>(), "CUSTOMERS_INFO"),
            new ColumnStateDTO(new TitleDto("location", "Локація", "Location"), "location", 20, false, true, 13, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("district", "Район", "District"), "ubsUser.address.district", 20, false, true, 14, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("address", "Адреса", "Address"), "ubsUser.address", 20, false, true, 15, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("commentToAddressForClient", "Коментар до адреси від клієнта", "Comment to address for client"), "commentToAddressForClient", 20, false, true, 16, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("bagsAmount", "К-сть пакетів", "Bags amount"), "bagsAmount", 20, false, true, 17, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("totalOrderSum", "Сума замовлення", "Total order sum"), "totalOrderSum", 20, false, true, 18, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("orderCertificateCode", "Номер сертифікату", "Order certificate code"), "orderCertificateCode", 20, false, true, 19, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("orderCertificatePoints", "Загальна знижка", "Order certificate points"), "orderCertificatePoints", 20, false, true, 20, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("amountDue", "Сума до оплати", "Amount due"), "amountDue", 20, false, true, 21, EditType.READ_ONLY, new ArrayList<>(), "CERTIFICATE"),
            new ColumnStateDTO(new TitleDto("commentForOrderByClient", "Коментар до замовлення від клієнта", "Comment for order by client"), "commentForOrderByClient", 20, true, true, 22, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("payment", "Оплата", "Payment"), "payment", 20, false, true, 23, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("dateOfExport", "Дата вивезення", "Date of export"), "dateOfExport", 20, false, true, 24, EditType.DATE, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("timeOfExport", "Час вивезення", "Time of export"), "timeOfExport", 20, false, true, 25, EditType.TIME, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("idOrderFromShop", "Номер замовлення з магазину", "Id order from shop"), "idOrderFromShop", 20, false, true, 26, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("receivingStation", "Станція приймання", "Receiving station"), "receivingStation", 20, false, true, 27, EditType.SELECT, receivingStationList(), "ORDERS_DETAILS"),
            new ColumnStateDTO(new TitleDto("responsibleManager", "Менеджер послуги", "Responsible manager"), "responsibleManager", 20, false, true, 28, EditType.SELECT, managerList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleCaller", "Менеджер обдзвону", "Responsible caller"), "responsibleCaller", 20, false, true, 29, EditType.SELECT, callerList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleLogicMan", "Логіст", "Responsible logic man"), "responsibleLogicMan", 20, false, true, 30, EditType.SELECT, logicManList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleDriver", "Водій", "Responsible driver"), "responsibleDriver", 20, false, true, 31, EditType.SELECT, driverList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("responsibleNavigator", "Штурман", "Responsible navigator"), "responsibleNavigator", 20, false, true, 32, EditType.SELECT, navigatorList(), "RESPONSIBLE"),
            new ColumnStateDTO(new TitleDto("commentsForOrder", "Коментарі до замовлення", "Comments for order"), "commentsForOrder", 20, false, true, 33, EditType.READ_ONLY, new ArrayList<>(), "ORDERS_DETAILS"))));
