...
public class BigOrderTableDtoMapper extends AbstractConverter<BigOrderTableViews, BigOrderTableDTO> {
    ...
    protected BigOrderTableDTO convert(BigOrderTableViews bigViews) {
        return new BigOrderTableDTO()
            ...
            .setRegion(new SenderLocation().setUa(bigViews.getRegionUk()).setEn(bigViews.getRegionEn()))
            .setCity(new SenderLocation().setUa(bigViews.getCityUk()).setEn(bigViews.getCityEn()))
            .setDistrict(new SenderLocation().setUa(bigViews.getDistrictUk()).setEn(bigViews.getDistrictEn()))
            .setAddress(new SenderLocation().setUa(bigViews.getAddressUk()).setEn(bigViews.getAddressEn()))
