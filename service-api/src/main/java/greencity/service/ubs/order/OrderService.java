...
/**
 * Service for creating and updating {@link Order} entities, including applying
 * points and forming full order details.
 */
public interface OrderService {
    /**
     * Forms and saves an {@link Order} based on provided request data. - Validates
    ...
    /**
     * Transfers user points to the given {@link Order}. - Validates that the user
