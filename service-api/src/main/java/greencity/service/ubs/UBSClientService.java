...
public interface UBSClientService {
    ...
    /**
     * Processes the form parameters received from WayForPay and converts them into a PaymentResponseWayForPay object.
     * This method performs the following:
     * - Checks that the form parameters are not empty.
     * - Parses the URL-encoded JSON from the first map key into a PaymentResponseDto.
     * - Validates the payment signature using generateResponseSignature.
     * - Calls validatePayment to update the payment status.
     *
     ...
     *         returns an error response if parameters are empty, invalid, or the signature check fails
     */
