...
public interface TelegramFeedbackService {
    ...
    /**
     * Processes a user's comment message during an active feedback session in a Telegram chat.
     *
     * @param message the Telegram {@link Message} containing the user's comment
     * @return a {@link SendMessage} response indicating the result: a thank-you message
     */
     ...
     * @param rating {@link Integer}the integer rating provided by the user (e.g. 1–5)
     * @return a {@link SendMessage} response indicating successful feedback submission
     */
