...
/**
 * Service for calculating order payment amount with respect to user bonus points.
 */
public interface PointCalculatorService {
    ...
    /**
     * Calculates the final order amount (in coins) after validating
     * and applying user's bonus points.
     *
